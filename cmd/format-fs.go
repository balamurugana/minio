...
func initFormatFS(fsPath string) (lockedConfigFile *lock.RLockedFile, err error) {
	...
	for {
		...
		// Release read lock to get write lock for writing new or migrated format configuration.
