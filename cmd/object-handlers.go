...
func (api objectAPIHandlers) GetObjectHandler(w http.ResponseWriter, r *http.Request) {
	...
	if s3Error := checkRequestAuthType(r, bucket, "s3:GetObject", setup.serverConfig.GetRegion()); s3Error != ErrNone {
...
func (api objectAPIHandlers) CopyObjectHandler(w http.ResponseWriter, r *http.Request) {
	...
	if s3Error := checkRequestAuthType(r, dstBucket, "s3:PutObject", setup.serverConfig.GetRegion()); s3Error != ErrNone {
		writeErrorResponse(w, s3Error, r.URL)
		return
	}
...
func (api objectAPIHandlers) NewMultipartUploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	if s3Error := checkRequestAuthType(r, bucket, "s3:PutObject", setup.serverConfig.GetRegion()); s3Error != ErrNone {
		writeErrorResponse(w, s3Error, r.URL)
		return
	}
...
func (api objectAPIHandlers) AbortMultipartUploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	if s3Error := checkRequestAuthType(r, bucket, "s3:AbortMultipartUpload", setup.serverConfig.GetRegion()); s3Error != ErrNone {
		writeErrorResponse(w, s3Error, r.URL)
		return
	}
...
func (api objectAPIHandlers) ListObjectPartsHandler(w http.ResponseWriter, r *http.Request) {
	...
	if s3Error := checkRequestAuthType(r, bucket, "s3:ListMultipartUploadParts", setup.serverConfig.GetRegion()); s3Error != ErrNone {
		writeErrorResponse(w, s3Error, r.URL)
		return
	}
...
func (api objectAPIHandlers) DeleteObjectHandler(w http.ResponseWriter, r *http.Request) {
	...
	if s3Error := checkRequestAuthType(r, bucket, "s3:DeleteObject", setup.serverConfig.GetRegion()); s3Error != ErrNone {
		writeErrorResponse(w, s3Error, r.URL)
		return
	}
