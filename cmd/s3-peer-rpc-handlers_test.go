...
func (s *TestRPCS3PeerSuite) testS3PeerRPC(t *testing.T) {
	...
	defer client.Close()
	err = client.Call("S3.SetBucketNotificationPeer", &BNPArgs, &AuthRPCReply{}, defaultRetryConfig, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = client.Call("S3.SetBucketListenerPeer", &BLPArgs, &AuthRPCReply{}, defaultRetryConfig, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = client.Call("S3.SetBucketPolicyPeer", &BPPArgs, &AuthRPCReply{}, defaultRetryConfig, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = client.Call("S3.Event", &evArgs, &AuthRPCReply{}, defaultRetryConfig, nil)
	if err != nil {
		t.Fatal(err)
	}
}
