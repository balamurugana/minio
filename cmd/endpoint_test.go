...
func TestNewEndpoint(t *testing.T) {
	...
	testCases := []struct {
		...
		{"c://foo", Endpoint{}, -1, fmt.Errorf("Unknown endpoint format")},
		{"ftp://foo", Endpoint{}, -1, fmt.Errorf("Unknown endpoint format")},
		{"http://server/path?location", Endpoint{}, -1, fmt.Errorf("Unknown endpoint format")},
		{"http://:/path", Endpoint{}, -1, fmt.Errorf("Invalid host in endpoint format")},
		{"http://:8080/path", Endpoint{}, -1, fmt.Errorf("Invalid host in endpoint format")},
		{"http://server:/path", Endpoint{}, -1, fmt.Errorf("Invalid host in endpoint format")},
