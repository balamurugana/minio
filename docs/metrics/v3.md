...
| Name                                        | Type      | Help                                             | Labels  |
|---------------------------------------------|-----------|--------------------------------------------------|---------|
| `minio_cluster_object_size_distribution`    | `gauge`   | Distribution of object sizes across a cluster    | `range` |
| `minio_cluster_object_version_distribution` | `gauge`   | Distribution of object versions across a cluster | `range` |
| `minio_cluster_object_usage_object_total`   | `counter` | Total number of objects in a cluster             |         |
